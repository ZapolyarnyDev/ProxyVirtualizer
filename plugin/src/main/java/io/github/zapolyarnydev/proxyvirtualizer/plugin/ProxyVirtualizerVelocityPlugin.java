...
@Plugin(id = "proxyvirtualizer", name = "ProxyVirtualizer", version = "1.0.0")
public final class ProxyVirtualizerVelocityPlugin {
  ...
  public ProxyVirtualizerVelocityPlugin(ProxyServer proxyServer, Logger logger) {
    ...
    this.launcher =
        new DefaultVirtualServerLauncher(
            proxyServer, serverContainer, connectionStorage, connector);
    ...
    this.api =
        ProxyVirtualizerApi.of(serverContainer, launcher, connector, connectionStorage, signalBus);
  }
    ...
    proxyServer
        ...
        .register(
            proxyServer
                ...
                .plugin(this)
                .build(),
            new VirtualServerCommand(
                serverContainer, proxyServer, launcher, connector, packetSender));
