...
public final class VelocityConnectorImpl implements Connector {
  ...
  @Override
  public boolean connect(VirtualServer server, Player player)
  ...
  private boolean sendAndLeaveVirtualServer(
      Player player, RegisteredServer server, boolean removePreviousOnSuccess) {
