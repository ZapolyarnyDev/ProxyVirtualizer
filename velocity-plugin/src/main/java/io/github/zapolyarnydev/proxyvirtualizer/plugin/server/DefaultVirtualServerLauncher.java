...
public final class DefaultVirtualServerLauncher implements Launcher {
  ...
  public VirtualServer launch(String name) throws VirtualServerAlreadyLaunchedException {
    synchronized (lock) {
      ...
      virtualServer.registerPacketVersion(
          VirtualPacketKeys.GAME_EVENT, targetProtocol, PACKET_ID_GAME_EVENT_1_21_4);
      virtualServer.registerPacketVersion(
          VirtualPacketKeys.PLAYER_POSITION, targetProtocol, PACKET_ID_PLAYER_POSITION_1_21_4);
