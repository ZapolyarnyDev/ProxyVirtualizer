...
public final class AdventureComponentParser {
  ...
  private Component parseMiniMessage(String input) {
    try {
      ...
      Object component =
          miniMessageClass.getMethod("deserialize", String.class).invoke(miniMessage, input);
  ...
  private Component parseLegacy(String input) {
    try {
      ...
      Object component =
          serializerClass.getMethod("deserialize", String.class).invoke(serializer, input);
      if (component instanceof Component parsed) {
        return parsed;
      }
    } catch (ReflectiveOperationException | RuntimeException ignored) {
